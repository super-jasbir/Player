...
import 'package:player/quiz/quiz_intro_screen.dart';
import 'package:player/tutorials/tutorials_screen.dart';
import 'package:player/wallet/wallet_screen.dart';
      ...
      body: SafeArea(
        child: Stack(
          ...
          children: [
            ...
            // The TUTORIAL sign is baked into the background artwork, so overlay
            // a transparent tap target on it to open the tutorials screen.
            Positioned(
              ...
              child: GestureDetector(
                ...
                onTap: () => Get.to(() => TutorialsScreen()),
              ),
            ),

            // The WALLET banner (towed by the plane) is also baked into the
            // artwork, so overlay a transparent tap target to open the wallet.
            Positioned(
              left: size.width * 0.30,
